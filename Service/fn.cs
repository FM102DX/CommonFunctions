...
namespace Ricompany.CommonFunctions
{
    ...
    public static class Fn
    {
        ...
        public static string generateNBlockGUID(int n, int bockLength = 4)
        {
            ...
            string[] array0 = new string[n];
            for (int i = 0; i < n; i++)
            {
                array0[i] = randomString(bockLength).ToUpper();
            }
            return string.Join("-", array0);
        }
        ...
        public static string Isn (object input)
        {
            string s;
            if (input == null) { s = ""; } else s = input.ToString();
            return s;
        }
